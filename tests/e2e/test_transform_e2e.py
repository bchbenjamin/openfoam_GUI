...
def test_box_translation_and_rotation_applied_to_mesh() -> None:
...
def test_box_non_uniform_scale_applied_to_mesh() -> None:
...
def test_cylinder_translation_and_rotation_applied_to_mesh() -> None:
...
def test_box_with_stl_projection_translation_and_rotation_applied() -> None:
