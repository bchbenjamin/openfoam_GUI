...
def test_build_frustum_pointy_cone():
...
def test_build_frustum_equal_radii():
...
def test_build_frustum_end_to_end(tmp_path):
...
def test_build_frustum_with_grading():
