...
class TestTutorialCopySetsPath:
    ...
    def test_copy_sets_case_path(self, tmp_path, mock_bpy_and_import) -> None:
    ...
    def test_copy_failure_does_not_set_case_path(self, tmp_path, mock_bpy_and_import) -> None:
    ...
    def test_copy_refuses_existing_destination(self, tmp_path, mock_bpy_and_import) -> None:
