...
def test_build_box_with_stl_projection() -> None:
...
def test_build_extrude_with_stl_projection() -> None:
...
def test_build_cylinder_with_stl_projection() -> None:
...
def test_build_revolve_with_stl_projection() -> None:
    """ """
    mesh = cb.Mesh()
    spec = {
        "type": "revolve",
...
def test_build_frustum_with_stl_projection() -> None:
    """ """
    mesh = cb.Mesh()
    spec = {
        "type": "frustum",
...
def test_build_loft_with_stl_projection() -> None:
    """ """
    mesh = cb.Mesh()
    spec = {
        "type": "loft",
...
def test_build_wedge_with_stl_projection() -> None:
    """ """
    mesh = cb.Mesh()
    spec = {
        "type": "wedge",
...
def test_build_cylinder_end_to_end(tmp_path) -> None:
...
def test_build_sphere_end_to_end(tmp_path) -> None:
...
def test_build_disk_end_to_end(tmp_path) -> None:
...
def test_unsupported_block_is_skipped() -> None:
...
def test_build_from_spec_box_end_to_end(tmp_path) -> None:
...
def test_build_from_spec_with_stl_projection(tmp_path) -> None:
...
def test_build_from_spec_extrude_end_to_end(tmp_path) -> None:
...
def test_build_from_spec_revolve_end_to_end(tmp_path) -> None:
