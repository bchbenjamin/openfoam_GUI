...
def test_parse_mixed_tris_and_quads():
...
def test_parse_skips_degenerate():
...
def test_find_vtk_files_nested():
...
def test_find_vtk_files_no_vtk_dir():
...
def test_find_vtk_files_sorted():
...
def test_load_vtk_pyvista_sphere():
    """
