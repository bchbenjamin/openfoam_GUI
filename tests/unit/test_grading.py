...
def _make_box_spec(grading_type="RATIO", grading=None, start_size=1e-4, end_size=1e-4):
    ...
    Args:
      grading_type:  (Default value = "RATIO")
      grading:  (Default value = None)
      start_size:  (Default value = 1e-4)
      end_size:  (Default value = 1e-4)
...
def test_grading_start_size() -> None:
...
def test_grading_symmetric() -> None:
