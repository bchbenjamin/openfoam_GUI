...
def test_build_loft_basic() -> None:
...
def test_build_loft_parallel_faces() -> None:
...
def test_build_loft_end_to_end(tmp_path) -> None:
...
def test_build_wedge_basic() -> None:
...
def test_build_wedge_5_degrees() -> None:
...
def test_build_wedge_end_to_end(tmp_path) -> None:
...
def test_build_mixed_spec_with_all_new_types(tmp_path) -> None:
