...
def _extract_with_forced_detection(context, volume_ratio=1.0):
    ...
    Args:
      context: 
      volume_ratio:  (Default value = 1.0)
...
def test_box_with_stl_projection() -> None:
...
def test_cylinder_detection() -> None:
...
def test_sphere_detection() -> None:
...
def test_infer_cylinder_axis_from_cap_normals() -> None:
...
def test_unsupported_warning_is_reported() -> None:
...
def test_all_mesh_objects_auto_included() -> None:
...
def test_block_type_dispatch_extrude() -> None:
...
def test_block_type_dispatch_revolve() -> None:
...
def test_sphere_spec_has_split_axis() -> None:
...
def test_non_uniform_scale_on_box_is_supported() -> None:
...
def test_non_uniform_scale_on_cylinder_is_unsupported() -> None:
...
def test_uniform_scale_is_supported() -> None:
...
def test_normalize_winding_corrects_inside_out() -> None:
...
def test_untagged_sketch_is_skipped() -> None:
